...
python phypartspiecharts.py astral.out.193loci.tre ./astral_sumtree33/astral_sumtrees33.out 193 --colors steelblue limegreen firebrick black
...
python phypartspiecharts.py RAxML_bipartitions.FcC_supermatrix_193loci.tree ./raxml_sumtree33/RAxML_sumtrees33.out 193 --colors steelblue limegreen firebrick black
